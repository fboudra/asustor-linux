		...
		IMG_UINT32 *pui32PageOffset)
{
	...
	else
	{
		...
		*pui32PageOffset = (IMG_UINT32)((unsigned long)pui8LinAddr & ui32DataPageMask);
	}
}
...
static IMG_BOOL PDumpWriteILock(PDBG_STREAM psStream, IMG_UINT8 *pui8Data, IMG_UINT32 ui32Count, IMG_UINT32 ui32Flags)
{
	...
	{
		PVR_DPF((PVR_DBG_MESSAGE, "PDumpWriteILock: Failed to write 0x%x bytes to stream 0x%x", ui32Count, (IMG_UINT32)(unsigned long)psStream));
		return IMG_TRUE;
	}
