                           ...
                           IMG_HANDLE         hUniqueTag)
{
	...
	{ 
		...
		eErr = PDumpOSBufprintf(hScript, ui32MaxLen, "MALLOC :%s:PA_" UINTPTR_FMT UINTPTR_FMT " %u %u 0x" UINTPTR_FMT "\r\n",
												psDevID->pszPDumpDevName,
												(IMG_UINTPTR_T)hUniqueTag,
												(IMG_UINTPTR_T)(ui32Page * ui32PageSize),
												ui32PageSize,
												ui32PageSize,
												(IMG_UINTPTR_T)(ui32Page * ui32PageSize));
		if(eErr != PVRSRV_OK)
	...
	for (ui32PageCounter = 0; ui32PageCounter < ui32NumPages; ui32PageCounter++)
	{
		if (!bInterleaved || (ui32PageCounter % 2) == 0)
		{
			...
			eErr = PDumpOSBufprintf(hScript, ui32MaxLen, "FREE :%s:PA_" UINTPTR_FMT DEVPADDR_FMT "\r\n",
									psDeviceNode->sDevId.pszPDumpDevName, (IMG_UINTPTR_T)hUniqueTag, sDevPAddr.uiAddr);
			if(eErr != PVRSRV_OK)
			{
				return eErr;
			}
							 ...
							 IMG_HANDLE hUniqueTag)
{
	...
	eErr = PDumpOSBufprintf(hScript, ui32MaxLen,
			 ...
			 psMMUAttrib->sDevId.pszPDumpDevName,
			 (IMG_UINTPTR_T)hUniqueTag,
			 (IMG_UINTPTR_T)((ui32Data & psMMUAttrib->ui32PDEMask) << psMMUAttrib->ui32PDEAlignShift),
				...
				if ((ui32PTE & psMMUAttrib->ui32PDEMask) != 0)
				{
					...
					eErr = PDumpOSBufprintf(hScript,
							ui32MaxLenScript,
							 ...
							 (IMG_UINTPTR_T)((ui32PTE & psMMUAttrib->ui32PDEMask) << psMMUAttrib->ui32PTEAlignShift));
					if(eErr != PVRSRV_OK)
					{
						return eErr;
					}
					...
					eErr = PDumpOSBufprintf(hScript,
							ui32MaxLenScript,
							 ...
							 psMMUAttrib->sDevId.pszPDumpDevName,
							 (IMG_UINTPTR_T)hUniqueTag1,
							 (IMG_UINTPTR_T)((sDevPAddr.uiAddr + ui32Offset) & ~ui32PageMask),
							   ...
							   IMG_HANDLE hUniqueTag2)
{
	...
	eErr = PDumpOSBufprintf(hScript,
			ui32MaxLenScript,
			"-- LDB :%s:PA_0x" UINTPTR_FMT DEVPADDR_FMT ":0x%08X 0x%zX 0x%08X %s\r\n",
			psMMUAttrib->sDevId.pszPDumpDevName,
			(IMG_UINTPTR_T)hUniqueTag1,
	...
	if ((sPDDevPAddr.uiAddr & psMMUAttrib->ui32PDEMask) != 0UL)
	{
		...
		eErr = PDumpOSBufprintf(hScript,
				ui32MaxLenScript,
				 ...
				 psMMUAttrib->sDevId.pszPDumpDevName,
				 (IMG_UINTPTR_T)hUniqueTag2,
				 (IMG_UINTPTR_T)sPDDevPAddr.uiAddr);
		if(eErr != PVRSRV_OK)
		{
			return eErr;
		}
		...
		eErr = PDumpOSBufprintf(hScript,
				ui32MaxLenScript,
				 "WRW :%s:PA_" UINTPTR_FMT DEVPADDR_FMT ":0x%08X :%s:$2\r\n",
				 psMMUAttrib->sDevId.pszPDumpDevName,
				 (IMG_UINTPTR_T)hUniqueTag1,
				 (IMG_UINTPTR_T)((sDevPAddr.uiAddr) & ~(psMMUAttrib->ui32DataPageMask)),
				 (sDevPAddr.uiAddr) & (psMMUAttrib->ui32DataPageMask),
				 psMMUAttrib->sDevId.pszPDumpDevName);
		if(eErr != PVRSRV_OK)
		{
		...
		eErr = PDumpOSBufprintf(hScript,
				ui32MaxLenScript,
				 ...
				 psMMUAttrib->sDevId.pszPDumpDevName,
				 (IMG_UINTPTR_T)hUniqueTag1,
				 (IMG_UINTPTR_T)((sDevPAddr.uiAddr + 4) & ~(psMMUAttrib->ui32DataPageMask)),
	...
	else
	{
		...
		eErr = PDumpOSBufprintf(hScript,
				 ui32MaxLenScript,
				 "WRW :%s:PA_" UINTPTR_FMT DEVPADDR_FMT ":0x%08X 0x" DEVPADDR_FMT "\r\n",
				 psMMUAttrib->sDevId.pszPDumpDevName,
				 (IMG_UINTPTR_T)hUniqueTag1,
				 sDevPAddr.uiAddr & ~ui32PageMask,
				 sDevPAddr.uiAddr & ui32PageMask,
