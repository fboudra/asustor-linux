							   ...
							   RESMAN_FREE_FN	pfnFreeResource)
{
	...
	PVR_DPF((PVR_DBG_MESSAGE, "ResManRegisterRes: register resource "
			"Context 0x%lx, ResType 0x%x, pvParam 0x%lx, ui32Param 0x%x, "
			"FreeFunc %lX",
...
PVRSRV_ERROR ResManFreeResByPtr(RESMAN_ITEM	*psResItem, IMG_BOOL bForceCleanup)
{
	...
	PVR_DPF((PVR_DBG_MESSAGE, "ResManFreeResByPtr: freeing resource at %lX",
									 ...
									 IMG_UINT32			ui32Param)
{
	...
	PVR_DPF((PVR_DBG_MESSAGE, "ResManFreeResByCriteria: "
			"Context 0x%lx, Criteria 0x%x, Type 0x%x, Addr 0x%lx, Param 0x%x",
												  ...
												  RESMAN_ITEM		*psItem)
{
	...
	PVR_DPF((PVR_DBG_MESSAGE,
			"FindResourceByPtr: psItem=%lX, psItem->psNext=%lX",
			(IMG_UINTPTR_T)psItem, (IMG_UINTPTR_T)psItem->psNext));

	PVR_DPF((PVR_DBG_MESSAGE,
			"FindResourceByPtr: Resource Ctx 0x%lx, Type 0x%x, Addr 0x%lx, "
			"Param 0x%x, FnCall %lX, Flags 0x%x",
			(IMG_UINTPTR_T)psResManContext,
			psItem->ui32ResType,
									  ...
									  IMG_BOOL		bForceCleanup)
{
	...
	PVR_DPF((PVR_DBG_MESSAGE,
			"FreeResourceByPtr: psItem=%lX, psItem->psNext=%lX",
			(IMG_UINTPTR_T)psItem, (IMG_UINTPTR_T)psItem->psNext));

	PVR_DPF((PVR_DBG_MESSAGE,
			"FreeResourceByPtr: Type 0x%x, Addr 0x%lx, "
			"Param 0x%x, FnCall %lX, Flags 0x%x",
			psItem->ui32ResType,
	...
	while(psCurContext != IMG_NULL)
	{
		...
		if (psCurContext->ppsThis != ppsThisContext)
		{
			PVR_DPF((PVR_DBG_WARNING,
					"psCC=%lX psCC->ppsThis=%lX psCC->psNext=%lX ppsTC=%lX",
		...
		while(psCurItem != IMG_NULL)
		{
			...
			{
				PVR_DPF((PVR_DBG_WARNING,
						"psCurItem=%lX psCurItem->ppsThis=%lX psCurItem->psNext=%lX ppsThisItem=%lX",
