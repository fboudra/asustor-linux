...
HASH_Insert_Extended (HASH_TABLE *pHash, IMG_VOID *pKey, IMG_UINTPTR_T v)
{
	...
	PVR_DPF ((PVR_DBG_MESSAGE,
              "HASH_Insert_Extended: Hash=0x%lx, pKey=0x%lx, v=0x%lx",
...
{
	PVR_DPF ((PVR_DBG_MESSAGE,
              "HASH_Insert: Hash=0x%lx, k=0x%lx, v=0x%lx",
...
HASH_Remove_Extended(HASH_TABLE *pHash, IMG_VOID *pKey)
{
	...
	PVR_DPF ((PVR_DBG_MESSAGE, "HASH_Remove_Extended: Hash=0x%lx, pKey=0x%lx",
	...
	for (ppBucket = &(pHash->ppBucketTable[uIndex]); ppBucket && *ppBucket != IMG_NULL; ppBucket = &((*ppBucket)->pNext))
	{
		...
		if (KEY_COMPARE(pHash, (*ppBucket)->k, pKey))
		{
			...
			PVR_DPF ((PVR_DBG_MESSAGE,
                      "HASH_Remove_Extended: Hash=0x%lx, pKey=0x%lx = 0x%lx",
                      (IMG_UINTPTR_T)pHash, (IMG_UINTPTR_T)pKey, v));
			return v;
		}
	}
	PVR_DPF ((PVR_DBG_MESSAGE,
              "HASH_Remove_Extended: Hash=0x%lx, pKey=0x%lx = 0x0 !!!!",
              (IMG_UINTPTR_T)pHash, (IMG_UINTPTR_T)pKey));
	return 0;
}
...
{
	PVR_DPF ((PVR_DBG_MESSAGE, "HASH_Remove: Hash=0x%lx, k=0x%lx",
...
HASH_Retrieve_Extended (HASH_TABLE *pHash, IMG_VOID *pKey)
{
	...
	PVR_DPF ((PVR_DBG_MESSAGE, "HASH_Retrieve_Extended: Hash=0x%lx, pKey=0x%lx",
			(IMG_UINTPTR_T)pHash, (IMG_UINTPTR_T)pKey));
	...
	for (ppBucket = &(pHash->ppBucketTable[uIndex]); *ppBucket != IMG_NULL; ppBucket = &((*ppBucket)->pNext))
	{
		...
		if (KEY_COMPARE(pHash, (*ppBucket)->k, pKey))
		{
			...
			PVR_DPF ((PVR_DBG_MESSAGE,
                      "HASH_Retrieve: Hash=0x%lx, pKey=0x%lx = 0x%lx",
                      (IMG_UINTPTR_T)pHash, (IMG_UINTPTR_T)pKey, v));
			return v;
		}
	}
	PVR_DPF ((PVR_DBG_MESSAGE,
              "HASH_Retrieve: Hash=0x%lx, pKey=0x%lx = 0x0 !!!!",
              (IMG_UINTPTR_T)pHash, (IMG_UINTPTR_T)pKey));
	return 0;
}
...
{
	PVR_DPF ((PVR_DBG_MESSAGE, "HASH_Retrieve: Hash=0x%lx, k=0x%lx",
			(IMG_UINTPTR_T)pHash, k));
