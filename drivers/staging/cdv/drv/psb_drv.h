...
extern int psb_get_vblank_timestamp(struct drm_device *dev, int pipe,
				    int *max_error,
				    struct timeval *vblank_time,
				    unsigned flags);
extern int psb_get_crtc_scanoutpos(struct drm_device *dev, int pipe, int *vpos,
				   int *hpos);
