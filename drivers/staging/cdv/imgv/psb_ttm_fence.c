...
bool ttm_fence_sync_obj_signaled(void *sync_obj)
{
	...
	return ttm_fence_object_signaled(fence, _PSB_FENCE_TYPE_EXE);
}
			    ...
			    bool lazy, bool interruptible)
{
	...
	return ttm_fence_object_wait(fence, lazy, interruptible, 
		_PSB_FENCE_TYPE_EXE);
}
...
int ttm_fence_sync_obj_flush(void *sync_obj)
{
	...
	return ttm_fence_object_flush(fence, _PSB_FENCE_TYPE_EXE);
}
